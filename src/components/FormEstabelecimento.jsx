...
export default function FormEstabelecimento() {
  ...
  return (
    <form
      className="space-y-5 md:space-y-6 mt-4"
    ...
    >
      <div>
        ...
        <input
          ...
          className={`mt-1 block w-full px-3 py-2 border ${
            form.nomeEstabelecimento && erros.nomeEstabelecimento
              ? "border-red-500"
              : "border-slate-300"
      ...
      <div>
        ...
        <input
          ...
          onChange={handleChange}
          className={`mt-1 block w-full px-3 py-2 border ${
            form.cnpj && erros.cnpj ? "border-red-500" : "border-slate-300"
          } rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500`}
      ...
      <div>
        ...
        <input
          ...
          onChange={handleChange}
          className={`mt-1 block w-full px-3 py-2 border ${
            form.email && erros.email ? "border-red-500" : "border-slate-300"
          } rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500`}
      ...
      <div>
        ...
        <input
          ...
          onChange={handleChange}
          className={`mt-1 block w-full px-3 py-2 border ${
            form.senha && erros.senha ? "border-red-500" : "border-slate-300"
          } rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500`}
